...
export default function TripDetailsPage() {
  ...
  const totalPrice = loadSize ? Number.parseFloat(loadSize) * trip.pricePerKg : 0
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Review trip information and book your shipment.</p>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <Calendar className="h-4 w-4 text-muted-foreground" />
                  <div>
                    <p className="font-medium">{new Date(trip.arrivalDate).toLocaleDateString()}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="font-medium">${trip.pricePerKg}/kg</p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{vehicle.capacity.toLocaleString()} kg capacity</p>
                  </div>
                </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-1 mb-2">
                    ...
                    <span className="text-muted-foreground">({carrier.reviewCount} reviews)</span>
                  </div>
                  <div className="space-y-1 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Member since {new Date(carrier.joinedDate).getFullYear()}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter your shipment details to book</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleBooking} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-muted-foreground">Max: {trip.availableCapacity.toLocaleString()} kg</p>
                </div>
                ...
                {loadSize && (
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      {loadSize} kg × ${trip.pricePerKg}/kg
                    </p>
                  </div>
                )}

                <Button type="submit" className="w-full" disabled={!loadSize || isBooking}>
