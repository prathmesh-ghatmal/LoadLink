...
export default function CarrierVehiclesPage() {
  ...
  const handleDelete = (vehicleId: string) => {
    if (confirm("Are you sure you want to delete this vehicle?")) {
      dataActions.deleteVehicle(vehicleId)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingVehicle) {
      dataActions.updateVehicle(editingVehicle, {
        type: formData.type as "truck" | "van" | "trailer" | "container",
    ...
    setFormData({ type: "", capacity: "", licensePlate: "", rcNumber: "" })
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your fleet and add new vehicles.</p>
        </div>
      ...
      {showAddForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {editingVehicle ? "Update vehicle information" : "Register a new vehicle to your fleet"}
            </CardDescription>
          </CardHeader>
          <CardContent>
